...
func (ec *executionContext) _Comment_by(ctx context.Context, field graphql.CollectedField, obj *models.Comment) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Comment_time(ctx context.Context, field graphql.CollectedField, obj *models.Comment) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Comment_kids(ctx context.Context, field graphql.CollectedField, obj *models.Comment) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	fc.Result = res
	return ec.marshalNComment2ᚕᚖgithubᚗcomᚋadwdᚋhackernewsᚑgraphqlᚋserverᚋmodelsᚐCommentᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_stories(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNStory2ᚕᚖgithubᚗcomᚋadwdᚋhackernewsᚑgraphqlᚋserverᚋmodelsᚐStoryᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNComment2ᚕᚖgithubᚗcomᚋadwdᚋhackernewsᚑgraphqlᚋserverᚋmodelsᚐCommentᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Comment) graphql.Marshaler {
...
func (ec *executionContext) marshalNStory2ᚕᚖgithubᚗcomᚋadwdᚋhackernewsᚑgraphqlᚋserverᚋmodelsᚐStoryᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Story) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
